...
// 🏡 Task 3: Function
/* Create a function called `mortgageCalculator` that combines all of the steps from task 1 and 2 and returns a sentence "{Name}, your 
...
console.log (monthlyRate.toFixed(3));
...
the monthly payment for 10 different interest rates at 0.5% increments plus or minus 2% from the inputted interest rate. Complete these 
...
interest =0.04;
function variableInterestRate(monthlyRate, interest, name,years){
    interest=interest-0.02;
    for ( let i=1; i<10; i++) {
        console.log (name, ", with an interest rate of", interest.toFixed(3), "your monthly rate is", mortgageCalculator(monthlyRate, interest, years));
        interest=interest+0.005;
}
}
variableInterestRate(200000, 0.04, "Vasya", 30);



// 🌟🌟🌟 STRETCH 🌟🌟🌟//

/* Attempt any of the stretch goals below once you have finished the work above. Remember as always, these may require additional research beyond 
